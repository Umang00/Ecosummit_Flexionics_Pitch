      ...
      <div className="w-full h-full bg-[#0a0f16] flex flex-col justify-center px-10 relative py-8">
        <div className="absolute top-8 right-10">
          <div className="inline-flex flex-col items-end">
            <span className="text-4xl font-bold text-teal-400">42%</span>
        ...
        <h1 className="text-4xl font-bold text-white mb-6 tracking-tight">Three Problems. One Response.</h1>
  ...
  },
  {
    ...
    content: (
      <div className="w-full h-full bg-[#05080c] flex flex-col justify-center px-10 relative py-8">
        <h1 className="text-3xl lg:text-4xl font-bold text-white mb-4 tracking-tight leading-tight">Three ways we create value<br/><span className="text-teal-400">from other peoples assets.</span></h1>
        
        <div className="grid grid-cols-1 gap-3 mt-4">
          {[
            { icon: <Server className="w-5 h-5" />, title: "Solution 1: Flexibility as a Service (FaaS)", tag: "For data centre and industrial asset owners", desc: "We connect to your asset and operate your grid flexibility — end to end. TSO prequalification, daily bid submission, 24/7 monitoring, compliance reporting. You earn the revenue. We handle everything. Not software. Not an aggregator. A full-stack operator with skin in the game." },
        ...
        <div className="absolute top-8 right-10 text-slate-500 font-medium tracking-wide text-xs border border-slate-800 p-2 rounded bg-slate-900/50">All three powered by our proprietary AI-enabled platform.</div>
      </div>
    ),
    ...
    content: (
      <div className="w-full h-full bg-[#0a0f16] flex flex-col relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col h-full justify-center px-10 py-8">
          ...
          <h1 className="text-4xl font-bold text-white mb-4 tracking-tight">Before we offered it to others —<br/>we built it on ourselves.</h1>
          <p className="text-slate-300 text-sm mb-6 max-w-3xl leading-relaxed">Flexionics operates two hybrid data centre sites in Sweden, running every one of our three solutions on our own infrastructure:</p>
          ...
          <div className="grid grid-cols-2 gap-4 mb-6 max-w-4xl">
            ...
            <div className="bg-[#05080c]/80 backdrop-blur-md border border-slate-700/50 p-4 rounded-xl flex items-center justify-between">
              <div>
                <h3 className="text-lg font-bold text-white">Utansjö, SE1</h3>
          ...
          <p className="text-slate-400 italic mt-6 text-xs max-w-2xl text-teal-200">The point: Every solution we offer to others — we use on our own sites. The platform wasn't built for a customer. It was built from necessity. And it works.</p>
        </div>
      </div>
    ),
      ...
      <div className="w-full h-full bg-[#05080c] flex flex-col justify-center px-10 py-8">
         ...
         <div className="grid grid-cols-3 gap-4 max-w-4xl mx-auto w-full">
            {[
              ...
              { label: "Revenue Growth", val: "9× in 5 mths" },
  ...
  },
  {
    ...
    content: (
      <div className="w-full h-full bg-[#05080c] flex flex-col justify-center px-10 relative py-8">
        ...
        <h1 className="text-4xl font-bold text-white tracking-tight mb-6">We earn twice on every asset. <br/><span className="text-slate-400">And we're opening that to others.</span></h1>
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 flex flex-col">
            ...
            <div className="space-y-2 text-xs text-slate-300">
              ...
              <div className="flex flex-col"><span className="text-teal-400 font-bold">Compute Revenue (Digital workloads)</span> <span className="text-[10px] mt-0.5">Continuously when not dispatched</span></div>
            </div>
          </div>
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 flex flex-col">
            <h3 className="text-lg font-bold text-white mb-3 border-b border-slate-700 pb-2">Upcoming Client Revenue (2026)</h3>
            <div className="space-y-2 text-xs text-slate-300">
              <div className="flex flex-col"><span className="text-teal-400 font-bold">FaaS Service Fee</span> <span className="text-[10px] mt-0.5">Data centre / industrial operators. Rev share or monthly retainer.</span></div>
              <div className="flex flex-col"><span className="text-teal-400 font-bold">Wind Farm Partnership</span> <span className="text-[10px] mt-0.5">Wind / solar operators. Rev share from flexibility income.</span></div>
        ...
        <div className="bg-[#0a0f16] border border-slate-800 rounded-lg p-3 mb-4 text-center">
           <span className="italic text-slate-400 text-xs">"The platform business multiplies our revenue without proportional CapEx. One team, one platform, many assets."</span>
        </div>
  ...
  },
  {
    ...
    content: (
      <div className="w-full h-full bg-[#0a0f16] flex flex-col justify-center px-10 relative py-8">
        ...
        <p className="text-slate-400 text-sm font-light mb-6">Four integrated technology layers, built entirely in-house.</p>
        
        <div className="grid grid-cols-4 gap-3 items-stretch mb-6">
          {[
            { title: "On-Site Controller", icon: <Cpu className="w-5 h-5" />, tasks: "Sub-200ms dispatch, <0.7s grid response. Local telemetry every 10 seconds. Stays operational even during connectivity loss. No SLA constraints.", hl: "Activation execution, power ramp, setpoint tracking" },
            { title: "Cloud Fleet Manager", icon: <Globe className="w-5 h-5" />, tasks: "Central oversight across all sites simultaneously. Bid management, win-rate analytics, audit trails, TSO-compatible evidence exports for every activation.", hl: "Fleet visibility, reporting, market interface" },
            { title: "AI Automation Engine", icon: <Network className="w-5 h-5" />, tasks: "Natural language querying. Automated trading desk — daily bids submitted via our trading software platform to our BSP partner each morning. Compliance output auto-generated.", hl: "Bid strategy, TSO reporting, market intelligence" },
            { title: "Predictive Health Monitor", icon: <Shield className="w-5 h-5" />, tasks: "24/7 AI-driven monitoring. Early-warning drift detection before it becomes a compliance issue. Automated alerting. Audit-ready event timelines.", hl: "Asset health, reliability, regulatory readiness" }
          ].map((item, i) => (
        ...
        <div className="max-w-4xl border-l-4 border-teal-500 pl-4 py-1">
          <p className="text-sm font-light text-slate-300 italic">"No human trader can respond in 700 milliseconds. No human team could audit 11,245 activations. This isn't AI as a feature. This is AI as the operating system."</p>
        </div>
      </div>
    ),
  ...
  },
  {
    ...
    content: (
      <div className="w-full h-full bg-[#0a0f16] flex flex-col justify-center px-10 relative py-8">
        ...
        <p className="text-slate-400 text-sm font-light mb-6">And opening the platform to the world.</p>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-[#05080c] border border-slate-800 p-4 rounded-xl flex gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 leading-relaxed">Launch FaaS for data centre operators outside our own sites. First clients onboarding. Revenue share model live. The platform opens.</p>
            </div>
          </div>
          <div className="bg-[#05080c] border border-slate-800 p-4 rounded-xl flex gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 leading-relaxed">Deploy compute infrastructure at a wind site in the Nordic region. Absorb curtailment. Eliminate imbalance penalties. First proof of the wind partnership model outside our own grid connection.</p>
            </div>
          </div>
          <div className="bg-[#05080c] border border-slate-800 p-4 rounded-xl flex gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 leading-relaxed">Open the AI Automation Engine to external flexibility operators. Enable any BRP or BSP to automate their bid submission, compliance reporting, and market analytics through our platform. First paying clients onboarded.</p>
            </div>
          </div>
          <div className="bg-[#05080c] border border-slate-800 p-4 rounded-xl flex gap-3">
        ...
        <div className="mt-6 bg-teal-900/10 border border-teal-500/20 p-3 rounded-lg inline-block text-white text-sm">
      ...
      <div className="w-full h-full bg-gradient-to-t flex flex-col justify-center px-10 relative py-8">
        ...
        <div className="relative z-10 w-full">
           ...
           <div className="flex justify-between items-center border-t border-slate-700/50 pt-6 bg-slate-900/30 p-5 rounded-xl">
              ...
              <div><span className="block text-slate-500 text-[10px] font-bold uppercase tracking-widest mb-1">Targeted Revenue CAGR</span><span className="text-lg font-bold text-white">67%<span className="text-[10px] text-slate-400 font-light block mt-1">2024–2027</span></span></div>
  ...
  },
  {
    ...
    content: (
      <div className="w-full h-full bg-[#05080c] flex flex-col justify-center px-10 relative py-8">
        ...
        <h1 className="text-4xl font-bold text-white tracking-tight mb-8">Who executes this.</h1>
          ...
          {[
            ...
            { name: "CTO", title: "CTO", desc: "AI & Machine Learning (Head of AI/ML, Barclays Investment Bank) / Quantitative Finance & Counterparty Risk / Technology Strategy & Automation", tag: "The machine" }
             ...
             <div key={i} className="bg-slate-900 border border-slate-800 p-4 rounded-xl flex flex-col">
               <div className="w-12 h-12 rounded-full bg-teal-500/20 mb-3 flex items-center justify-center text-teal-400 font-bold text-lg">{m.name.charAt(0)}</div>
               <h3 className="text-lg font-bold text-white mb-1">{m.name === "CTO" ? <span className="opacity-0">Hidden</span> : m.name}</h3>
               <p className="text-teal-400 font-bold text-xs tracking-wide uppercase mb-2 text-emerald-400">{m.title}</p>
               <div className="flex-1 space-y-1 mt-1">
                 {m.desc.split(" / ").map((line, idx) => (
                    <p key={idx} className="text-slate-300 text-[10px] font-light tracking-wide leading-relaxed">• {line}</p>
                 ))}
               </div>
               <p className="border-t border-slate-800 mt-3 pt-3 text-[9px] font-bold text-slate-500 uppercase tracking-widest">{m.tag}</p>
             </div>
          ))}
        </div>
      </div>
  ...
  },
  {
    ...
    content: (
      <div className="w-full h-full bg-[#05080c] flex flex-col items-center justify-center p-10 text-center">
        ...
        <h3 className="text-2xl font-light text-slate-300 mb-4">Series A — Convertible Preferred Equity</h3>
        <p className="text-teal-400 mb-8 italic text-sm">14 MW → 44 MW. One raise. Three times the capacity.</p>

        <div className="grid grid-cols-2 gap-6 w-full max-w-5xl text-left">
          <div className="bg-slate-900 border border-slate-800 p-6 rounded-xl">
            <h4 className="text-lg font-bold text-white mb-4 uppercase tracking-wider">Use of Funds — Phase 1 ($10.5M)</h4>
            <ul className="space-y-3">
              {[
                ...
                <li key={i} className="flex gap-2 text-slate-300 items-start text-xs">
                  <div className="mt-0.5"><Shield className="w-3.5 h-3.5 text-teal-400 shrink-0" /></div>
          ...
          <div className="bg-slate-900 border border-slate-800 p-6 rounded-xl flex flex-col justify-between">
            <div>
              <h4 className="text-lg font-bold text-white mb-4 uppercase tracking-wider">Financial Projections</h4>
              <div className="grid grid-cols-4 gap-2 mb-3 border-b border-slate-800 pb-2 font-bold text-slate-500 text-[10px] uppercase tracking-widest">
                 <div>Year</div><div>Revenue</div><div>EBITDA</div><div>Margin</div>
              </div>
              <div className="grid grid-cols-4 gap-2 mb-2 text-slate-300 text-xs border-b border-slate-800 pb-2">
                 <div>2024</div><div>$12M</div><div>$3M</div><div>25%</div>
              </div>
              <div className="grid grid-cols-4 gap-2 mb-3 text-slate-300 text-xs border-b border-slate-800 pb-2">
                 <div>2025</div><div>~$20M</div><div>~$9M</div><div>~45%</div>
              </div>
              <div className="grid grid-cols-4 gap-2 mb-3 text-white font-bold tracking-wide text-xs">
              ...
              <div className="grid grid-cols-2 gap-4 mt-4 pt-3 border-t border-slate-800">
                <div className="flex flex-col"><span className="text-slate-500 text-[9px] uppercase font-bold tracking-widest">IRR on Phase 1</span><span className="text-emerald-400 font-bold text-sm">&gt;50%</span></div>
                <div className="flex flex-col"><span className="text-slate-500 text-[9px] uppercase font-bold tracking-widest">Per MW Payback</span><span className="text-white font-bold text-sm">~18 months</span></div>
              </div>
            </div>
          </div>
        </div>
    ...
    content: (
      <div className="w-full h-full bg-[#05080c] flex flex-col justify-center px-10 relative py-8">
        ...
        <div className="text-center w-full">
           <span className="text-teal-500 font-bold block text-sm">bipin.patel@flexionics.com | www.flexionics.com</span>
        </div>
      </div>
    ),
